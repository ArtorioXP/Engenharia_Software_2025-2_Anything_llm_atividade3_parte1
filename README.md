# Anything-LLM – Diagnóstico e Auditoria de Projeto
...
Este repositório contém a implementação da Atividade 3 (Parte 1) de Engenharia de Software II (2025.2), cujo objetivo é **Diagnóstico e Auditoria de Projeto de um projeto real do GitHub**.
...
- Auditoria
- Fluxo Atual, Riscos e Gargalos
- Diagramas de Processo e de Pipeline
- Referências
